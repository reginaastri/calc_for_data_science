...
text(.5, .7, expression(over(partialdiff*h, partialdiff*t)== -over(partialdiff*v, partialdiff*x)), cex=2)
text(.5, .3, expression(over(partialdiff*v, partialdiff*t) == -g*h*over(partialdiff*h, partialdiff*x)), cex=2)
```
